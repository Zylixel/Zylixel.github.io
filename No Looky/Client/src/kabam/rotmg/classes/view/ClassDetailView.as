...
public class ClassDetailView extends Sprite {
    ...
    public function ClassDetailView() {
        ...
        this.classNameText = new TextFieldDisplayConcrete().setSize(20).setColor(0x33ffcc).setBold(true).setAutoSize(TextFieldAutoSize.CENTER).setTextWidth(TEXT_WIDTH);
        this.classNameText.filters = [_local_1];
        this.waiter.push(this.classNameText.textChanged);
        addChild(this.classNameText);
        this.classDescriptionText = new TextFieldDisplayConcrete().setSize(14).setColor(0x33ffcc).setTextWidth(TEXT_WIDTH).setWordWrap(true);
        ...
        this.questCompletionText = new TextFieldDisplayConcrete().setSize(14).setColor(0x33ffcc).setBold(true);
        ...
        this.levelTitleText = new TextFieldDisplayConcrete().setSize(14).setColor(0x33ffcc).setBold(true);
        ...
        this.levelText = new TextFieldDisplayConcrete().setSize(16).setColor(0x33ffcc).setBold(true);
        this.levelText.filters = [_local_1];
        this.waiter.push(this.levelText.textChanged);
        addChild(this.levelText);
        this.fameTitleText = new TextFieldDisplayConcrete().setSize(14).setColor(0x33ffcc).setBold(true);
        ...
        this.nextGoalText = new TextFieldDisplayConcrete().setSize(14).setColor(0x33ffcc).setBold(true);
        ...
        this.nextGoalDetailText = new TextFieldDisplayConcrete().setSize(14).setColor(0x33ffcc);
