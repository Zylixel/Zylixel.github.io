        ...
        private _ Mountain = () => Behav()
            .Init("White Demon",
                ...
                new Threshold(0.18,
                    ...
                    new EggLoot(EggRarity.Uncommon, 0.01)
                    )
            )
            ...
            .Init("Arena Headless Horseman",
                new State(
                    ...
                    new DropPortalOnDeath("Haunted Cemetery Portal", 100)
                )
            )
            .Init("Sprite God",
                new State(
            ...
            .Init("Medusa",
                new State(
                    ...
                    new DropPortalOnDeath("Abyss of Demons Portal", 50)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.04),
                new TierLoot(7, ItemType.Weapon, 0.02),
                new TierLoot(8, ItemType.Weapon, 0.01),
            ...
            .Init("Flying Brain",
                new State(
                    ...
                    new DropPortalOnDeath("Mad Lab Portal", 50)
                    ),
                new TierLoot(6, ItemType.Weapon, 0.04),
                new TierLoot(7, ItemType.Weapon, 0.02),
                new TierLoot(7, ItemType.Armor, 0.04),
