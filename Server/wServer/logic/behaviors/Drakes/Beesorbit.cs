...
{
    public class BeesOrbit : CycleBehavior
    {
        ...
        private readonly float playerCircle;

        public BeesOrbit(double speed, double radius, double acquireRange = 10,
            string target = null, double? speedVariance = null, double? radiusVariance = null, double? playerCircle = null)
        {
            ...
            this.playerCircle = (float)playerCircle;
        }
