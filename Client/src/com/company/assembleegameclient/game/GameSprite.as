...
public class GameSprite extends AGameSprite
{
    ...
    public function hudModelInitialized() : void
    {
        ...
        {
            this.hudView.scaleY = stage.stageHeight / 600;
            this.hudView.scaleX = stage.stageWidth / 800;
            this.hudView.y = 300 * (1 - stage.stageHeight / 600);
            this.hudView.x = 400 + stage.stageWidth / 800 * 200;
        }
        else
        {
            this.hudView.x = 200 + stage.stageWidth / 2;
        }
        addChild(hudView);
    }
    ...
    override public function initialize() : void
    {
        ...
        if(Parameters.data_.scaleUI)
        {
            this.creditDisplay_.scaleX = stage.stageWidth / 800;
            this.creditDisplay_.scaleY = stage.stageHeight / 600;
        }
        if(Parameters.data_.altUI && stage.stageHeight > 605 + this.creditDisplay_.height)
        {
            this.creditDisplay_.x = 400 + stage.stageWidth / 2;
        }
        else
        {
            this.creditDisplay_.x = this.hudView.x - 12;
        }
        this.creditDisplay_.y = 300 - stage.stageHeight / 2;
    ...
    private function showGiftStatusDisplay() : void
    {
        ...
        this.giftStatusDisplay.x = 405 - stage.stageWidth / 2;
        this.giftStatusDisplay.y = 335 - stage.stageHeight / 2;
    ...
    private function positionPackage() : void
    {
        ...
        this.currentPackage.y = 408 - stage.stageWidth / 2;
    }
    ...
    private function showGuildText() : void
    {
        ...
        if(Parameters.data_.scaleUI)
        {
            this.guildText_.scaleX = stage.stageWidth / 800;
            this.guildText_.scaleY = stage.stageHeight / 600;
        }
        this.guildText_.x = this.rankText_.x + this.rankText_.width;
        this.guildText_.y = 306 - stage.stageHeight / 2;
    ...
    private function showRankText() : void
    {
        ...
        if(Parameters.data_.scaleUI)
        {
            this.rankText_.scaleX = stage.stageWidth / 800;
            this.rankText_.scaleY = stage.stageHeight / 600;
        }
        this.rankText_.x = 408 - stage.stageWidth / 2;
        this.rankText_.y = 304 - stage.stageHeight / 2;
        this.displaysPosY = this.displaysPosY + UIUtils.NOTIFICATION_SPACE;
    ...
    public function connect() : void
    {
        if(!this.isGameStarted)
        {
            ...
            if(Parameters.data_.fullscreenv2)
            {
    ...
    private function onScreenResize(_arg_1:Event) : void
    {
        ...
        if(_local_6 != null)
        {
            if(this.evalIsNotInCombatMapArea())
            {
                if(Parameters.data_.scaleUI)
                {
                    ...
                    this.rankText_.scaleX = this.rankText_.scaleY = this.guildText_.scaleX = this.guildText_.scaleY = 1
                }
                this.rankText_.x = 408 - stage.stageWidth / 2;
                this.rankText_.y = 304 - stage.stageHeight / 2;
            ...
            if (this.giftStatusDisplay != null) {
                if(Parameters.data_.scaleUI) {
                    this.giftStatusDisplay.scaleX = stage.stageWidth / 800;
                    this.giftStatusDisplay.scaleY = stage.stageHeight / 600;
                } else {
                    this.giftStatusDisplay.scaleX = this.giftStatusDisplay.scaleY = 1;
                }
                this.giftStatusDisplay.x = 405 - stage.stageWidth / 2;
                this.giftStatusDisplay.y = 335 - stage.stageHeight / 2;
            }
            ...
            this.chatBox_.x = 400 - stage.stageWidth / 2;
            this.chatBox_.y = stage.stageHeight / 2;
            if(this.creditDisplay_ != null)
            {
                if(Parameters.data_.scaleUI)
                {
                    ...
                    this.creditDisplay_.scaleX = this.creditDisplay_.scaleY = 1;
                }
                if(!Parameters.data_.scaleUI && stage.stageHeight > 605 + this.creditDisplay_.height)
                {
                    this.creditDisplay_.x = 400 + stage.stageWidth / 2;
                }
                else
    ...
    private function onEnterFrame(_arg_1:Event) : void
    {
        ...
        if(this.focus)
        {
            camera_.configureCamera(this.focus,!!Boolean(_local_6)?Boolean(Boolean(Boolean(_local_6.isHallucinating()))):Boolean(Boolean(false)));
        ...
        if (this.rankText_ != null && map != null) {
            this.rankText_.draw(map.player_.numStars_);
        }
        if (this.creditDisplay_ != null) {
