...
public class EquipmentToolTip extends ToolTip {
    ...
    private function addTierText():void {
        ...
        if (((((_local_1) && (_local_2))) && (_local_3))) {
            ...
            if (_local_4) {
                ...
                this.tierText.setStringBuilder(new StaticStringBuilder(TextKey.Legendary));
            }
            else if (this.objectXML.hasOwnProperty("Event")) {
                this.tierText.setColor(0xDC143C);
                this.tierText.setStringBuilder(new StaticStringBuilder(TextKey.Event));
            }
            else {
    ...
    private function addLevelTagToEffectsList():void {
        if (((this.objectXML.hasOwnProperty("Level1")) && (!((this.comparisonResults.processedTags.hasOwnProperty(this.objectXML.Level5.toXMLString()) == true))))) {
    ...
    private function addEquipmentItemRestrictions():void {
        if (this.objectXML.hasOwnProperty("Treasure") == false && !Parameters.data_.altUI) {
    ...
    override protected function alignUI():void {
        ...
        if (this.objectXML.hasOwnProperty("Legendary")) {
            ...
            this.tierText.y = ((this.icon.height / 2) - (this.tierText.height / 2));
            this.tierText.x = (MAX_WIDTH - 40);
        }
        else if (this.tierText) {
            this.tierText.y = ((this.icon.height / 2) - (this.tierText.height / 2));
