...
public class Options extends Sprite {
    ...
    private static const TABS:Vector.<String> = new <String>[TextKey.OPTIONS_CONTROLS, TextKey.OPTIONS_HOTKEYS, TextKey.OPTIONS_CHAT, TextKey.OPTIONS_GRAPHICS, TextKey.OPTIONS_SOUND, "Experimental"]; //TextKey.OPTIONS_FRIEND];
    ...
    public function Options(_arg_1:GameSprite) {
        ...
        graphics.moveTo(-5000, 100);
        graphics.lineTo(8000, 100);
        graphics.lineStyle();
    ...
    private function addGraphicsOptions():void {
        ...
        this.addOptionAndPosition(new ChoiceOption("fullscreenv2", makeOnOffLabels(), [true, false], "Fullscreen V2", "Enables/Disables Game Scaling. Causes more lag with bigger monitors", updateStage));
        this.addOptionAndPosition(new ChoiceOption("scaleUI", makeOnOffLabels(), [true, false], "Scale GUI", "Determines scaling gold/fame count, etc. Useless without Fullscreen V2", updateStage));
        this.addOptionAndPosition(new ChoiceOption("altUI", makeOnOffLabels(), [true, false], "Alternate UI", "Change to use a more transparent user interface", updateStage));
    }
