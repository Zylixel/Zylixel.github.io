...
public class Map extends AbstractMap
{
    ...
    override public function setGroundTile(_arg_1:int, _arg_2:int, _arg_3:uint) : void
    {
        ...
        var _local_5:int = _arg_1 < width_ - 1?int(_arg_1 + 1):int(_arg_1);
        var _local_6:int = _arg_2 < height_ - 1?int(_arg_2 + 1):int(_arg_2);
        var _local_7:int = _arg_1 > 0?int(_arg_1 - 1):int(_arg_1);
        while(_local_7 <= _local_5)
        {
            _local_8 = _arg_2 > 0?int(_arg_2 - 1):int(_arg_2);
    ...
    public function correctMapView(_arg_1:Camera) : Point
    {
        ...
        var mscale:int = 3 - Parameters.data_.mscale;
        x = -_local_2.x * 800 / WebMain.STAGE.stageWidth;
        y = -_local_2.y * 600 / WebMain.STAGE.stageHeight;
        this.scaleX = 600 / (Parameters.data_.mscale * 500);
        this.scaleY = 600 / (Parameters.data_.mscale * 500);
    ...
    override public function draw(_arg_1:Camera, _arg_2:int) : void
    {
        ...
        var _local_5:BasicObject = null;
        var _local_6:int = 0;
        var _local_12:uint = 0;
        var _local_13:Render3D = null;
        var _local_14:int = 0;
        ...
        if(player_ != null && !Parameters.screenShotMode_ && !Parameters.data_.fullscreenMode)
        {
            gradientOverlay_.visible = true;
            gradientOverlay_.x = _local_17.right - (!!Boolean(Parameters.data_.uiShadow)?210:10);
        ...
        if(Parameters.isGpuRender() && Renderer.inGame)
        {
            ...
            while(_local_14 < this.graphicsData_.length)
            {
                ...
                else if(this.graphicsData_[_local_14] is GraphicsSolidFill && GraphicsFillExtra.isSoftwareDrawSolid(GraphicsSolidFill(this.graphicsData_[_local_14])))
                {
                    this.graphicsDataStageSoftware_.push(this.graphicsData_[_local_14]);
                    this.graphicsDataStageSoftware_.push(this.graphicsData_[_local_14 + 1]);
                    this.graphicsDataStageSoftware_.push(this.graphicsData_[_local_14 + 2]);
        ...
        {
            this.darkness.x = -300;
            this.darkness.y = !!Boolean(Parameters.data_.centerOnPlayer)?Number(Number(Number(-525))):Number(Number(Number(-515)));
