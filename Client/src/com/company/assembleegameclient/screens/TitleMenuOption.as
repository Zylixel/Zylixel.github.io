...
public class TitleMenuOption extends Sprite {
    ...
    private var isColorTransform:Boolean;
    private var originalWidth:Number;
    private var originalHeight:Number;
    private var active:Boolean;
    private var color:uint = 0x00a89b;
    private var hoverColor:uint;
    private var noScale:Boolean;

    public function TitleMenuOption(_arg_1:String, _arg_2:int, _arg_3:Boolean, _arg_4:uint = 0x00a89b, _arg_5:Boolean = true, _arg_6:uint = 0x01F0DE, _arg_7 = false) {
        this.size = _arg_2;
        this.isPulse = _arg_3;
        this.color = _arg_4;
        this.isColorTransform = _arg_5;
        this.hoverColor = _arg_6;
        this.noScale = _arg_7;
        this.textField.setSize(_arg_2).setColor(_arg_4).setBold(true);
    ...
    public function setNormalColor(_arg_1:uint):void {
        this.textField.setColor(_arg_1);
    }
    ...
    private function onEnterFrame(_arg_1:Event):void {
        ...
        if (this.noScale) {
            this.textField.y = (WebMain.STAGE.stageHeight / 600);
        }
    }
    ...
    protected function onMouseOver(_arg_1:MouseEvent):void {
        if (this.isColorTransform == true) {
            this.setColorTransform(OVER_COLOR_TRANSFORM);
        }
        else {
            this.setNormalColor(this.hoverColor);
        }
    }
    ...
    protected function onMouseOut(_arg_1:MouseEvent):void {
        if (this.isColorTransform == true){
            ...
            this.setNormalColor(this.color);
        }
    }
