...
public class AccountScreen extends Sprite {
    ...
    private function makeGuildText():void {
        ...
        //this.guildText.x = 92;
        this.guildText.x = 498 - (stage.stageWidth /2);
        //this.guildText.y = 6;
        this.guildText.y = 306 - (stage.stageHeight /2);
    ...
    private function makeRankText():void {
        ...
        //this.rankText.x = 36;
        this.rankText.x = 436 - (stage.stageWidth / 2 );
        //this.rankText.y = 4;
        this.rankText.y = 304 - (stage.stageHeight /2);
    ...
    public function setAccountInfo(_arg_1:AccountInfoView):void {
        ...
        _local_2.x = 390 + (stage.stageWidth / 2);
        //_local_2.y = 2;
        _local_2.y = 302 - (stage.stageHeight / 2);
