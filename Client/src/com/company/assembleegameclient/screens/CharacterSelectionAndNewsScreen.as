...
public class CharacterSelectionAndNewsScreen extends Sprite {
    ...
    private var BOUNDARY_LINE_ONE_Y:int = 406 - (WebMain.STAGE.stageHeight / 2);
    private var CHARACTER_LIST_Y_POS:int = 408 - (WebMain.STAGE.stageHeight / 2);
    ...
    public function CharacterSelectionAndNewsScreen() {
        ...
        BOUNDARY_LINE_ONE_Y = 406 - (600 / 2);
        CHARACTER_LIST_Y_POS = 408 - (600 / 2);
    ...
    private function createNews():void {
        ...
        this.news.x = NEWS_X;
        this.news.y = 412 - (WebMain.STAGE.stageHeight / 2);
        addChild(news);
    }

    private function createScrollbar():void {
        this.scrollBar = new Scrollbar(16, (WebMain.STAGE.stageHeight) - 199);
        this.scrollBar.x = 443;
        this.scrollBar.y = 413 - (WebMain.STAGE.stageHeight / 2);
    ...
    private function createNewsText():void {
        ...
        this.newsText.y = 379 - (WebMain.STAGE.stageHeight / 2);
    ...
    private function createOpenCharactersText():void {
        ...
        this.openCharactersText.y = 379 - (WebMain.STAGE.stageHeight / 2);
    ...
    private function createOpenGraveyardText():void {
        ...
        this.openGraveyardText.y = 379 - (WebMain.STAGE.stageHeight / 2);
    ...
    private function createCreditDisplay():void {
        ...
        this.creditDisplay.x = 400 + WebMain.STAGE.stageWidth / 2;
        this.creditDisplay.y = 320 - (WebMain.STAGE.stageHeight / 2);
    ...
    private function createChooseNameLink():void {
        ...
        //this.nameChooseLink_.x = 800;
        this.nameChooseLink_.x = (WebMain.STAGE.stageWidth / 2);
        this.nameChooseLink_.y = 350 - (WebMain.STAGE.stageHeight / 2);
    ...
    private function createNameText():void {
        ...
        //this.nameText.y = 24;
        //this.nameText.x = (WebMain.STAGE.stageWidth / 2);
        this.nameText.x = (WebMain.STAGE.stageWidth / 4) + (this.nameText.width / 2);
        this.nameText.y = 324 - (WebMain.STAGE.stageHeight / 2);
    ...
    function getReferenceRectangle():Rectangle {
        ...
        if (stage) {
            _local_1 = new Rectangle(0, 0, 800, 600);
        }
        return (_local_1);
    }
    ...
    private function createBoundaryLines():void {
        ...
        this.lines.graphics.moveTo(-5000, this.BOUNDARY_LINE_ONE_Y);
        this.lines.graphics.lineTo(5000, this.BOUNDARY_LINE_ONE_Y);
        this.lines.graphics.moveTo(466, this.BOUNDARY_LINE_ONE_Y);
