...
public class GameServerConnectionConcrete extends GameServerConnection {
    ...
    public function mapMessages():void {
        ...
        _local_1.map(DIALOG).toMessage(DialogResult).toMethod(this.onDialogResult);
    }
    ...
    private function onDialogResult(arg1:DialogResult):void {
        outstandingBuy_ = null;
        this.openDialog.dispatch(new CustomDialog(arg1));
    }
