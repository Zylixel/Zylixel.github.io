...
public class ChatListItemFactory {
    ...
    private function processName():String {
        ...
        if ((((_local_1.charAt(0) == "#")) || _local_1.charAt(0) == "*" || _local_1.charAt(0) == "!" || _local_1.charAt(0) == "$" || _local_1.charAt(0) == "%" || _local_1.charAt(0) == "^" || ((_local_1.charAt(0) == "@")))) {
    ...
    private function getNameColor():uint {
        ...
        if (this.message.name.charAt(0) == "!") { //Helper
            return (0x2ECC71);
        }
        if (this.message.name.charAt(0) == "$") { //Mod
            return (0x11806A);
        }
        if (this.message.name.charAt(0) == "%") { //Admin
            return (0xECC103);
        }
        if (this.message.name.charAt(0) == "^") { //Server Heads
            return (0xFFFF00);
        }
    ...
    private function getTextColor():uint {
        ...
        if (_local_1.charAt(0) == "%") { //Admin
            return (0xECC103);

        }
        if (_local_1.charAt(0) == "^") { //Server Heads
            return (0xFFFF00);
        }
        if (this.message.recipient == GUILD) {
            return (10944349);
