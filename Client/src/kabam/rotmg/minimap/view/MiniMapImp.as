...
public class MiniMapImp extends MiniMap
{
    ...
    private var maps:Vector.<BitmapData>;

    public function MiniMapImp(_arg_1:int, _arg_2:int)
    {
        this.scores = new Vector.<int>(13);
    ...
    override public function draw() : void
    {
        ...
        else if(_local_14.x < this.windowRect_.right)
        {
        ...
        else if(_local_14.y < this.windowRect_.bottom)
        {
        ...
        for each(_local_2 in map.goDict_)
        {
            if(!(_local_2.props_.noMiniMap_ || _local_2 == this.focus))
            {
                ...
                if(_local_4 != null)
                {
                    if(map.name_ == "Nexus" && _local_4.numStars_ <= Parameters.data_.chatStarRequirement && Parameters.data_.HidePlayerFilter)
                    {
                        continue;
                    }
                    ...
                    else if(Parameters.data_.lockHighlight && _local_4.starred_)
                    {
                        _local_3 = 4240365;
                    }
                    else if(_local_4.isFellowGuild_)
                    {
                        _local_3 = 65280;
                    }
                    else
                ...
                else if(_local_2 is Portal || _local_2 is GuildHallPortal)
                {
                    _local_3 = 255;
                }
                else if(_local_2 is Container && _local_2.objectType_ != 1284 && _local_2.objectType_ != 1860)
                {
                    _local_3 = gameObjectToColor(_local_2);
                }
                else
