...
public class LegendsTab extends Sprite {
    ...
    private static const OVER_COLOR:int = 0x00a89b;
    private static const DOWN_COLOR:int = 0x00a89b;
    ...
    private function makeLabel(_arg_1:Timespan):void {
        this.label = new TextFieldDisplayConcrete().setSize(20).setColor(0x00a89b);
