...
public class ClassDetailView extends Sprite {
    ...
    public function ClassDetailView() {
        ...
        this.classNameText = new TextFieldDisplayConcrete().setSize(20).setColor(0x00a89b).setBold(true).setAutoSize(TextFieldAutoSize.LEFT).setTextWidth(TEXT_WIDTH);
        this.classNameText.filters = [_local_1];
        this.waiter.push(this.classNameText.textChanged);
        addChild(this.classNameText);
        this.classDescriptionText = new TextFieldDisplayConcrete().setSize(14).setColor(0x00a89b).setTextWidth(TEXT_WIDTH).setWordWrap(true);
        ...
        this.questCompletionText = new TextFieldDisplayConcrete().setSize(14).setColor(0x00a89b).setBold(true);
        ...
        this.levelTitleText = new TextFieldDisplayConcrete().setSize(14).setColor(0x00a89b).setBold(true);
        ...
        this.levelText = new TextFieldDisplayConcrete().setSize(16).setColor(0x01F0DE).setBold(true);
        this.levelText.filters = [_local_1];
        this.waiter.push(this.levelText.textChanged);
        addChild(this.levelText);
        this.fameTitleText = new TextFieldDisplayConcrete().setSize(14).setColor(0x00a89b).setBold(true);
        ...
        this.fameText = new TextFieldDisplayConcrete().setSize(16).setColor(0x01F0DE).setBold(true);
        ...
        this.nextGoalText = new TextFieldDisplayConcrete().setSize(14).setColor(0x00a89b).setBold(true);
        ...
        this.nextGoalDetailText = new TextFieldDisplayConcrete().setSize(14).setColor(0x00a89b);
